...
export default function CustomSectionID({
  ...
  return (
    <section className="w-full xl:after:absolute relative after:w-[50%] after:h-full after:right-0 after:top-0 after:bg-main-black bg-main-black xl:bg-main-white">
      <div
        className={`px-4 z-[2] md:px-8 min-h-[100vh] lg:h-[calc(100vh-24px)] lg:px-10 pt-32 lg:pt-[120px] py-10 flex flex-col gap-10  overflow-hidden lg:min-h-[820px] md:items-start md:after:absolute after:w-[65%] after:-right-64 after:bg-main-black after:skew-x-[-25deg] after:h-full xl:after:w-[55%] after:top-0 md:bg-main-white relative ${customClassesSection}`}
      >
