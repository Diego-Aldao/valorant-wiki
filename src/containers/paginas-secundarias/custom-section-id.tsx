...
export default function CustomSectionID({
  ...
  return (
    <section
      className={`px-4 md:px-8 h-full lg:px-10 mt-96 md:mt-0 md:pt-20 lg:pt-[120px] py-10 flex flex-col gap-10  overflow-hidden lg:min-h-[820px] md:items-start after:absolute after:-left-44 after:top-0 after:w-[95%] lg:after:w-[80%] lg:after:-left-48 after:skew-x-[-25deg] after:h-full after:bg-main-white after:-z-[2] after:hidden after:md:block relative min-h-[calc(100vh-88px)] ${customClassesSection}`}
    >
