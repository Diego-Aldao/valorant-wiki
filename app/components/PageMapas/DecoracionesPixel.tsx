...
export default function DecoracionesPixel() {
  return (
    <>
      ...
      {/*BOTTOM RIGHT */}
      <div className="absolute bottom-10 z-[2] right-0 xl:right-48 w-14 h-14 bg-main-black opacity-80"></div>
      <div className="absolute bottom-24 z-[2] right-0 xl:right-48 w-14 h-14 bg-main-black opacity-60"></div>
      <div className="hidden xl:block absolute bottom-[152px] z-[2] right-0 xl:right-48 w-14 h-14 bg-main-black opacity-30"></div>
      {/*TOP RIGHT */}
      <div className="absolute top-10 z-[2] right-0 xl:right-48 w-14 h-14 bg-main-black "></div>
      <div className="absolute top-24 z-[2] right-0 xl:right-48 w-14 h-14 bg-main-black opacity-80"></div>
      <div className="absolute top-[152px] z-[2] right-0 xl:right-48 w-14 h-14 bg-main-black opacity-50"></div>
      <div className="absolute top-10 right-14 xl:right-[248px] z-[2] w-14 h-14 bg-main-black opacity-80"></div>
    </>
  );
}
